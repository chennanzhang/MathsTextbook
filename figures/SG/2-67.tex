...
\begin{tikzpicture}[>=latex,scale=1.0,inner sep=1pt]
  ...
  \tkzDefPoints{3/1/O,3/4/H,4/1/R}
  \tkzDefPoints{6/1/O',6/4/H',5.0/0.9/M,6.4/0.6/N,7.0/1.1/P,5.6/1.4/Q}
  ...
  \tkzDefPointOnLine[pos=0.6](H',P)\tkzGetPoint{P'}
  ...
  \tkzInterLL(E,F)(H',P)\tkzGetPoint{Lr}
  \tkzDrawSegments[densely dashed](H,O H',Q P,Q Q,M H',O' P',Q' Q',M' Ll,Lr LL,LR)
  \tkzDrawPoints[fill=black](O,O1,O',O2)
  \tkzDrawSegments[semithick](F,C C,D D,E H,rr H,rl M,N N,P H',M H',N H',P M',N' N',P' LR,Ll Lr,E F,LL)
  ...
  \tkzLabelLine[pos=0.5,left](O',O2){$h$}
  \tkzLabelLine[pos=0.5,left](O2,H'){$x$}
  \tkzLabelPoint[right](O){$S$}
  \tkzLabelPoint[right](O1){$S'$}
  \tkzLabelPoint[right](O'){$S$}
  \tkzLabelPoint[left](O2){$S'$}
