...
\begin{tikzpicture}[>=latex,scale=1.0]
  \begin{scope}
    ...
    \draw[thin,->](0,-0.8)--(0,3.0)node[left]{$y$};
    ...
    \tkzLabelLine[pos=2.0,right](B,C){$l_1$}
    \tkzDrawLine[semithick,add = 0.25 and 1.0](A,D)
    \tkzLabelLine[pos=2.0,left](A,D){$l_2$}
    \tkzMarkAngle[size=0.4](A,B,D)
    \tkzLabelAngle[pos=0.8](A,B,D){$\alpha_1$}
    \tkzMarkAngle[size=0.2](E,A,D)
    \tkzLabelAngle[pos=0.4](E,A,D){$\alpha_2$}
