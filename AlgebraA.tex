...
\tableofcontents
\mainmatter
\input{contents/algebra1-1.tex} % ok
\input{contents/algebra1-2.tex} % ok
\input{contents/algebra1-3.tex} % ok
\appendix
\input{contents/algebra-app.tex} % ok
\end{document}